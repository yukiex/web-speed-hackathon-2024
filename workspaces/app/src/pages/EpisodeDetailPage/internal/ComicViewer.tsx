...
export const ComicViewer: React.FC<Props> = ({ episodeId }) => {
  ...
  // ビュアーの高さ
  // _.clamp の代わりに条件演算子を使用
  const viewerHeight = candidatePageHeight < MIN_VIEWER_HEIGHT ? MIN_VIEWER_HEIGHT : candidatePageHeight > MAX_VIEWER_HEIGHT ? MAX_VIEWER_HEIGHT : candidatePageHeight;
